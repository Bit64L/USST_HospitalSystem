	...
	private void initialize(OrderInformation orderInfor) {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				patient.insertPatientInformation(patientName.getText().toString(),sex,patientAge.getText().toString(),patientPhoneNumber.getText().toString(),patientId,ordertime.getText().toString());
